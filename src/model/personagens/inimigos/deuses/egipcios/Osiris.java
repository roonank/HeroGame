...
public class Osiris extends MagoInimigo {
    ...
    public void usarHabilidade(Habilidade habilidade, model.interfaces.ICombatente alvo) {
        if (podeUsarHabilidade(habilidade)) {
            // Osiris tem 20% de chance de crítico mágico com stun
            ...
            System.out.println("Osiris não pode usar esta habilidade!");
        }
    }
    ...
    public void explosaoArcana(model.interfaces.ICombatente alvo) {
        if (getPontosMagia() >= 15) {
            ...
            alvo.receberDano(dano);
            System.out.println("Osiris libera uma Explosão Arcana Marinha causando " +
                    dano + " de dano devastador das profundezas!");
        } else {
            System.out.println("Osiris não tem magia suficiente para esta habilidade!");
        }
    }

    // Habilidade única de Osiris - Fúria dos Mares
    public void furiaDosMares(model.interfaces.ICombatente alvo) {
        System.out.println("Osiris desencadeia a Fúria dos Mares!");
    ...
    public void mareAlta() {
        ...
        System.out.println("Osiris invoca a Maré Alta, recuperando " +
